/**
 * Tầng <b>domain</b> của context {@code genealogy}: entity/aggregate, value object, domain service
 ...
 * Entity JPA và adapter nằm ở {@code vn.giapha.genealogy.infrastructure}.</p>
 */

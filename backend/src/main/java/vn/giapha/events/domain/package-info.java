/**
 * Tầng <b>domain</b> của context {@code events}: entity/aggregate, value object, domain service
 ...
 * Entity JPA và adapter nằm ở {@code vn.giapha.events.infrastructure}.</p>
 */

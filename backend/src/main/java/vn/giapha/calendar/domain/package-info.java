/**
 * Tầng <b>domain</b> của context {@code calendar}: entity/aggregate, value object, domain service
 ...
 * Entity JPA và adapter nằm ở {@code vn.giapha.calendar.infrastructure}.</p>
 */

/**
 * Tầng <b>domain</b> của context {@code kinship}: entity/aggregate, value object, domain service
 ...
 * Entity JPA và adapter nằm ở {@code vn.giapha.kinship.infrastructure}.</p>
 */

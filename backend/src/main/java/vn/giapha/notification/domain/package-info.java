/**
 * Tầng <b>domain</b> của context {@code notification}: entity/aggregate, value object, domain service
 ...
 * Entity JPA và adapter nằm ở {@code vn.giapha.notification.infrastructure}.</p>
 */

/**
 * Tầng <b>domain</b> của context {@code reporting}: entity/aggregate, value object, domain service
 ...
 * Entity JPA và adapter nằm ở {@code vn.giapha.reporting.infrastructure}.</p>
 */
package vn.giapha.reporting.domain;

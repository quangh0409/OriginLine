/**
 * Tầng <b>domain</b> của context {@code heritage}: entity/aggregate, value object, domain service
 ...
 * Entity JPA và adapter nằm ở {@code vn.giapha.heritage.infrastructure}.</p>
 */
package vn.giapha.heritage.domain;

...
export function TreeCanvasInner({
  ...
  useEffect(() => {
    ...
    const raf = requestAnimationFrame(() => {
      ...
      fitView(INITIAL_FIT_VIEW_OPTIONS);
    });
  ...
  return (
    ...
    >
      <Background gap={24} color={colorTokens.border} />
      ...
      <MiniMap
        ...
        maskColor="rgba(140,45,25,0.08)"
        nodeColor={(n) => {
          const data = n.data as PersonNodeData | undefined;
          return data?.treeNode.person.isAlive ? colorTokens.primary : colorTokens.borderDark;
        }}
      />
    </ReactFlow>
  );
